                    ...
                    <div className={s.mainContainer}>
                        ...
                        <Header
                            headList={[
                                ...
                                { headli2: "증명서관리" },
                                { headli3: "증명서발급" },
                                { headinfo: "필요한 증명서를 선택하고 발급 정보를 입력하여 출력하세요."}
                            ]}
                        />
                        ...
                        <div className={s.certifiC}>
                            ...
                            <div className={s.certifi_Cont}>
                                <div className={s.certifi_card}>
                                    <p className={s.img}><img src="/Briefcase Business (1).png" alt="" /></p>
                                ...
                                <div className={s.certifi_card2}>
                                    <p className={s.img}><img src="/Award.png" alt="" /></p>
                                ...
                                <div className={s.certifi_card2}>
                                    <p className={s.img}><img src="/Banknote (1).png" alt="" /></p>
                                ...
                                <div className={s.certifi_card2}>
                                    <p className={s.img}><img src="/Receipt Text.png" alt="" /></p>
                        ...
                        <div className={s.certifi_input}>
                            ...
                            <div className={s.cerIn_cont}>
                                ...
                                <div className={s.cerIn_list}>
                                    <div className={s.cerIn_li}>
                                        <label style={{display:"flex"}}>용도<p style={{color:"#EF4444"}}>*</p></label>
                                        <select>
                                    ...
                                    <div className={s.cerIn_li}>
                                        <label style={{display:"flex"}}>제출처<p style={{color:"#EF4444"}}>*</p></label>
                                        <input type="text" placeholder="예:국민은행 OO지점" style={{backgroundColor:"white"}}/>
                                    </div>
                                    <div className={s.cerIn_li}>
                                        <label style={{display:"flex"}}>발급부수<p style={{color:"#EF4444"}}>*</p></label>
                                    ...
                                    <div className={s.cerIn_li}>
                                        <label style={{display:"flex"}}>언어선택<p style={{color:"#EF4444"}}>*</p></label>
                                ...
                                <div className={s.cerIn_list} style={{marginTop:"-13px"}}>
                                    <div className={s.cerIn_li}>
                                        <label>기준일</label>
                                        <input type="text" style={{backgroundColor:"white", width:"180px"}}/>
                                    </div>
                                    <div className={s.cerIn_li}>
                                        <label>발급목적 (선택)</label>
                                        <input type="text" placeholder="발급 목적을 간략히 입력하세요" style={{backgroundColor:"white", width:"958px"}}/>
                                    </div>
                                </div>
                                <span className={s.hr}></span>
