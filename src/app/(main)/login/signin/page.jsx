...
export default function page(){
    ...
    const goLogin = async () => {
        ...
        localStorage.setItem("accessToken", res.data.data.accessTocken);
    }
            ...
            <div className={s.maincontainer}>
                ...
                <div className={s.main}>
                    ...
                    <div className={s.mainLeft}>
                        ...
                        <p className={s.leftcont}>직원 채용부터 급여, 근태까지<br />하나의 플랫폼으로 관리하세요.</p>
                        ...
                        <div className={s.leftbutton}>
                            <div className={s.buttonLi}>
                                <p className={s.img}><img src="/Users.png" alt="" /></p>
                            ...
                            <div className={s.buttonLi}>
                                <p className={s.img}><img src="/Banknote.png" alt="" /></p>
                                <div className={s.buttontext}>
                                    <p>급여관리</p>
                            ...
                            <div className={s.buttonLi}>
                                <p className={s.img}><img src="/Clock.png" alt="" /></p>
                                <div className={s.buttontext}>
                                    <p>근태관리</p>
                    ...
                    <div className={s.mainRight}>
                        <div className={s.rightcont}>
                            ...
                            <span style={{fontSize:"15px", color:"#6B7280"}}>계정에 로그인하여 업무를 시작하세요</span>
                            <div className={s.rightInput}>
                                <label style={{marginTop:"10px"}}>이메일</label>
                                <input type="text" placeholder='이메일 주소를 입력하세요' onChange={(e) => setLoginInfo(prev=>({...prev, email: e.target.value}))}
                                />
                            </div>
                            <div className={s.rightInput1}>
                                <label>비밀번호</label>
                                <input type="password" placeholder='비밀번호를 입력하세요' onChange={(e)=> setLoginInfo(prev => ({...prev, password:e.target.value}))}/>
                            </div>
