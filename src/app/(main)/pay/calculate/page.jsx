          ...
          <div className={s.mainContainer}>
            <Header
              headList={[
                ...
                {
                  headinfo:
                    "계산기준월을 선택하고 조건을 설정한 후 전 직원 급여를 자동 계산합니다.",
                },
              ]}
            />
            ...
            <ul className={s.appoint_card}>
              <li>
                <p style={{ display: "flex", marginLeft: "75px" }}>
                ...
                >
                  {" "}
                  <span
                    className={s.app_span}
                    style={{ backgroundColor: "#60A5FA" }}
                  ></span>{" "}
                  기본급 25,760,000 + 수당 2,880,000
                </p>
              </li>
              <li>
                <p style={{ display: "flex", marginLeft: "75px" }}>
                ...
                <span>4,128,060원</span>
                <p className={s.lighter} style={{ display: "flex" }}>
                  {" "}
                  <span
                    className={s.app_span}
                    style={{ backgroundColor: "#E11D48" }}
                  ></span>{" "}
                  4대보험 3,408,060 + 소득세 720,000
                </p>
              </li>
              <li>
                <p style={{ display: "flex", marginLeft: "75px" }}>
                ...
                <span>24,511,940원</span>
                <p className={s.lighter} style={{ display: "flex" }}>
                  {" "}
                  <span
                    className={s.app_span}
                    style={{ backgroundColor: "#16A34A", marginLeft: "55px" }}
                  ></span>{" "}
                  1인 평균 3,063,993원
                </p>
              </li>
              ...
              <li>
                ...
                <p className={s.lighter} style={{ display: "flex" }}>
                  ...
                  <span
                    className={s.app_span}
                    style={{ backgroundColor: "#D97706", marginLeft: "60px" }}
                  ></span>{" "}
                  야근수당 증가 영향
                </p>
              </li>
