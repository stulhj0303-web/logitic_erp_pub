          ...
          <div className={s.mainContainer}>
            <Header
              headList={[
                ...
                {
                  headinfo:
                    "직원별 기본급여 및 수당 기준 정보를 등록하고 관리합니다.",
                },
              ]}
            />
            ...
            <ul className={s.appoint_card}>
              ...
              <li>
                <p>최고 기본급</p>
                <span>4,700,000원</span>
                <p className={s.box} style={{ color: "#7C3AED" }}>
                  이영희 · 차장
                </p>
              </li>
              <li>
                <p>월 총 인건비</p>
                <span>29,300,000원</span>
                <p className={s.lighter}>기본급 합계 기준</p>
              </li>
              <li>
                <p>월 총 수당</p>
                <span>3,340,000원</span>
                <p className={s.lighter}>수당 합계 기준</p>
              </li>
              <li>
                <p>등록 인원</p>
                <span>8명</span>
                <p className={s.lighter}>미등록 0명</p>
              </li>
            </ul>
            ...
            <div className={s.status_head}>
              ...
              <div>
                ...
                <ul className={s.head_list}>
                  <li>
                    <span style={{ backgroundColor: "#DBEAFE" }}></span>기본급
                  </li>
                  <li>
                    <span style={{ backgroundColor: "#FEF9C3" }}></span>수당항목
                  </li>
                  <li>
                    <span style={{ backgroundColor: "#D1FAE5" }}></span>계좌정보
                  </li>
                </ul>
              </div>
            </div>
