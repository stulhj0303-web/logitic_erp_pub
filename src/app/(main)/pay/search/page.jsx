                            ...
                            <div className={s.mainContainer}>
                                ...
                                <Header
                                    headList={[
                                        { headli1: "급여관리" },
                                        { headli3: "급여조회" },
                                        { headinfo: "연도별 급여 수령 내역 및 월별 명세서를 조회합니다."}
                                    ]}
                                />
                                ...
                                <div className={s.status_head}>
                                    ...
                                    <div>
                                        <ul className={s.head_list}>
                                            <li><span style={{backgroundColor:"#1B3A6B"}}></span>실지급액</li>
                                            <li><span style={{backgroundColor:"#3B82F6"}}></span>이번달 (7월)</li>
                                            <li><span style={{backgroundColor:"#E2E8F0"}}></span>미지급</li>
                                        </ul>
                                    </div>
                                </div>
                                <div className={s.search_cont}>
                                    ...
                                    <div className={s.search_cont_box}>
                                        <div className={s.search_box} style={{backgroundColor:'#EFF6FF', border:'1px solid #BFDBFE', width:'122px'}}>
                                            <p style={{color:'#3B82F6'}}>2025년 누적</p>
                                            <span style={{color:'#1E40AF'}}>17,023,590</span>
                                            <p style={{color:'#3B82F6'}}>원</p>
                                        </div>
                                        <div className={s.search_box} style={{backgroundColor:'#F0FDF4', border:'1px solid #BBF7D0', width:'97px'}}>
                                            <p style={{color:'#16A34A'}}>최고 지급월</p>
                                            <span style={{color:'#15803D'}}>5월</span>
                                            <p style={{color:'#16A34A'}}>2,490,000원</p>
                                        </div>
                                        <div className={s.search_box} style={{backgroundColor:'white', border:'1px solid #E5E7EB', width:'112px'}}>
                                ...
                                <div className={s.cal_box}>
                                    ...
                                    <div className={s.search_year}>
                                        <button className={s.year_btn1}>
                                            2023
                                        </button>
                                        <button className={s.year_btn2}>
                                            2024
                                        </button>
                                        <button className={s.year_btn3}>
                                            2025
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className={s.status_head}>
                                    ...
                                    <div>
                                        <p className={s.receipt_span} style={{color:"#2563EB", fontWeight:'bold'}}>7개월 조회</p> 
                                        <ul className={s.head_list}>
                                ...
                                <ul className={s.status_sum}>
                                    <li><img src="/Sigma.png" alt="" /><span>7개월 합계</span></li>
                                    <li>24,500,000</li>
                                    <li>2,660,000</li>
                                    <li>27,160,000</li>
                                    <li>3,136,410</li>
