            ...
            <div className={s.appoint_cont}>
              <div className={s.appoint_vac}>
                ...
                <div className={s.appoint_vac_box}>
                  ...
                  <div className={s.box_info}>
                    <label>
                      휴가 종류<span className={s.red}> *</span>
                    </label>
                  ...
                  <div className={s.box_info}>
                    <label>
                      휴가 기간<span className={s.red}> *</span>
                    </label>
                  ...
                  <div className={s.box_info}>
                    <label>
                      휴가 사유<span className={s.red}> *</span>
                    </label>
                    <input
                      type="text"
                      placeholder="휴가 사유를 입력하세요"
                      className={s.box_input2}
                    />
                  </div>
                ...
                <div className={s.vac_calender}>
                  ...
                  <div className={s.calender_cont}>
                    ...
                    <ul className={s.calender_info}>
                      <li>
                        <span style={{ backgroundColor: "#1B3A6B" }}></span>
                        <p>신청일</p>
                      </li>
                      <li>
                        <span style={{ backgroundColor: "#FCA5A5" }}></span>
                        <p>기사용</p>
                      </li>
                      <li>
                        <span style={{ backgroundColor: "#FDE68A" }}></span>
                        <p>공휴일</p>
                      </li>
                    </ul>
                  </div>
