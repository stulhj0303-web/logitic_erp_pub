                            ...
                            <div className={s.mainContainer}>
                                ...
                                <Header
                                    headList={[
                                        ...
                                        { headli2: "근태관리" },
                                        { headli3: "휴가일수설정" },
                                        { headinfo: "연도별 휴가 정책 및 직급별 기준 일수를 설정합니다."}
                                    ]}
                                />
                                ...
                                <div className={s.vacation_chart}>
                                    <div className={s.chart_day}>
                                        ...
                                        <ul className={s.chart_list} style={{color:"black", backgroundColor:"white"}}>
                                            <li>임원</li>
                                            <li><div>25</div></li>
                                            <li><div style={{fontWeight:"400"}}>10</div></li>
                                            <li className={s.chart_toggle}><label className={s.work_toggle}>
                                        ...
                                        <ul className={s.chart_list} style={{color:"black", backgroundColor:"white"}}>
                                            <li>차장</li>
                                            <li><div>18</div></li>
                                            <li><div style={{fontWeight:"400"}}>5</div></li>
                                            <li className={s.chart_toggle}><label className={s.work_toggle}>
                                                <input role='switch' type='checkbox' id="toggle" checked/> 
                                            </label></li>
                                            <li className={s.chart_list_last}>-</li>
                                        ...
                                        <ul className={s.chart_list} style={{color:"black", backgroundColor:"white"}}>
                                            <li>사원</li>
                                            <li><div style={{border:"1px solid #2563EB", color:"#2563EB"}}>11</div></li>
                                            <li><div style={{fontWeight:"400"}}>0</div></li>
                                            <li className={s.chart_toggle}><label className={s.work_toggle}>
                                        ...
                                        <div className={s.chart_year}>
                                            ...
                                            <div className={s.year_cont}>
                                                <div className={s.year_info}>
                                                    ...
                                                    <span>근속 2년 초과 시 매 2년마다 1일씩 최대 25일까지 가산됩니다.</span>
                                                </div>
                                                ...
                                                <ul className={s.year_chart_cont}>
                                                    <li>1년 미만</li>
                                                    <li style={{fontWeight:"400", color:"#9CA3AF"}}>+0일</li>
                                                    <li>11일</li>
                                                </ul>
                                                <ul className={s.year_chart_cont}>
                                                    <li>1년 이상 ~ 3년 미만</li>
