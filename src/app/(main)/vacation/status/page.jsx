                        ...
                        <div className={s.InfoMain}>
                            ...
                            <div className={s.mainContainer}>
                                ...
                                <ul className={s.appoint_card}>
                                    <li><p>대상 인원</p><span>8명</span></li>
                                    <li><p>평균 부여일수</p><span>16.1일</span></li>
                                    <li><p>평균 사용일수</p><span>10.4일</span></li>
                                    <li><p>평균 잔여일수</p><span>5.6일</span></li>
                                    <li><p>잔여 3일 이하</p><span>3명</span></li>
                                    <li><p>휴가 미사용</p><span>0명</span></li>
                                </ul>
                                ...
                                <div className={s.status_head}>
                                    ...
                                    <div>
                                        ...
                                        <ul className={s.head_list}>
                                            <li><span style={{backgroundColor:"#DBEAFE"}}></span>사용일수</li>
                                            <li><span style={{backgroundColor:"#BBF7D0"}}></span>잔여일수</li>
                                            <li><span style={{backgroundColor:"#FECACA"}}></span>3일 이하 경고</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <ul className={s.status_title}>
                                    ...
                                    <li><p style={{fontWeight:'bold', color:"#1D4ED8"}}>연차</p><span style={{fontWeight:'lighter', color:"#93C5FD"}}>사용</span></li>
                                    <li><p style={{fontWeight:'bold', color:"#0369A1"}}>반차</p><span style={{fontWeight:'lighter', color:"#7DD3FC"}}>사용</span></li>
                                    <li><p style={{fontWeight:'bold', color:"#DC2626"}}>병가</p><span style={{fontWeight:'lighter', color:"#FCA5A5"}}>사용</span></li>
                                    <li><p style={{fontWeight:'bold', color:"#D97706"}}>특별휴가</p><span style={{fontWeight:'lighter', color:"#FCD34D"}}>사용</span></li>
                                    <li ><p style={{fontWeight:'bold', color:"#6B7280"}}>기타</p><span style={{fontWeight:'lighter', color:"#9CA3AF"}}>사용</span></li>
                                ...
                                <ul className={s.status_sum}>
                                    <li><img src="/Sigma.png" alt="" /><span>합계 / 평균</span></li>
                                    <li>120일</li>
                                    <li>66일</li>
                                    <li>4일</li>
                                    <li>2일</li>
                                    ...
                                    <li>-</li>
                                    <li>80일</li>
                                    <li>40일<p style={{fontWeight:'lighter', color:"#16A34A", fontSize:'10px'}}>평균 5.0일</p></li>
                                    <li></li>
                                </ul>
